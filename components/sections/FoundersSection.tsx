...
export function FoundersSection() {
  return (
    <section className="overflow-hidden bg-charcoal px-5 py-24 text-white sm:px-8 sm:py-32 lg:px-12 lg:py-40">
      <div className="mx-auto max-w-[1600px]">
        <div className="grid gap-12 lg:grid-cols-[1.15fr_.85fr]">
          ...
          <div className="relative min-h-[28rem] overflow-hidden rounded-[2rem] bg-white/[0.045] p-6 ring-1 ring-white/10 sm:p-9 lg:mt-32">
        ...
        <div className="mt-16 grid gap-px bg-white/18 md:grid-cols-2 lg:mt-24">
          {founders.map((founder, index) => (
            <article key={`${founder.name}-${index}`} className="bg-charcoal py-9 md:px-9 md:first:pl-0 md:last:pr-0">
